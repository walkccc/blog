...
Google gives clear picture [here](https://google.github.io/swift/#line-wrapping). The key point is to be careful to judge **breakable** or **unbreakable** units.
...
- Omit needless words.
  ...
  Occasionally, it is necessary to repeat type information to avoid ambituity. However, in general it is better to use a word that describes a parameter's _role_ rather than its type.
